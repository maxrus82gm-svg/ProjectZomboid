...
- Дата проверки подключения: 2026-07-06 21:15:44 +05:00
...
- Backup: `\\192.168.0.77\ZomboidServerConfig\servertest.ini.backup_TASK009_2026-07-06_21-14-26`
- `WorkshopItems=` применён в `servertest.ini`: да
- `Mods=` применён в `servertest.ini`: да
- Workshop ID применено: 57
- ModID применено: 70
